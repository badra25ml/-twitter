function FireTweetSearch(ref, stem, resultsHandler) {
  this._ref = ref;
  this._term = stem;
...
FireTweetSearch.prototype.containsTerm = function(term) {
  if (term.length < 3) {
    return false;
  } else {
...
FireTweetSearch.prototype.updateTerm = function(term) {
  this._term = term;
  this._raiseFilteredResults();
};

FireTweetSearch.prototype.stopSearch = function() {
